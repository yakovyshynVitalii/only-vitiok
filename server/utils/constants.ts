...
export const DEFAULT_ENV: Record<string, string> = {
  ...
  WD_TAGGER_SPACE: "SmilingWolf/wd-tagger",
  WD_TAGGER_MODEL_REPO: "SmilingWolf/wd-swinv2-tagger-v3",
  WD_TAGGER_GENERAL_THRESHOLD: "0.35",
  WD_TAGGER_CHARACTER_THRESHOLD: "0.85",
  HF_TOKEN: "",
